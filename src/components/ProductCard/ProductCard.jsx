...
export default function ProductCard(props) {
  ...
  return (
    <div className="productDesign">
      <div>
        <img src={currentProduct.image} alt="image" height={150} width={110} />
      </div>
